...
public extension Array where Element == [String: Any] {
    func binarySearch(withIndex index: Any, key: String, value: Any) -> (obj: Element, index: Int)? {
        guard let searchResult = binarySearchAll(key: key, value: value), let lowerIndex = searchResult.lowerIndex, let upperIndex = searchResult.upperIndex else { return nil }
